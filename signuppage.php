...
<!-- -----------------------------doctor part from here------------------------------------------ -->
                ...
                <form method="post" action="signup_process_doctor.php" enctype="multipart/form-data">
                <div class="form">
            <div class="inputfield">
                <label>First Name</label>
                <input type="text" class="input" name = "dfname"required>
            </div>  
            <div class="inputfield">
                <label>Last Name</label>
                <input type="text" class="input" name = "dlname"required>
            </div>  
            <div class="inputfield">
                <label>Password</label>
                <input type="password" class="input" name = "dpass"required>
             </div> 
             <div class="inputfield">
                <label>Confirm Password</label>
                <input type="password" class="input" name = "dcpass"required>
             </div> 
             <div class="inputfield">
                <label>Reg No</label>
                <input type="text" class="input" name = "drgno"required>
            </div>
             <div class="inputfield">
                <label>Designation</label>
                <input type="text" class="input" name = "ddeg" required>
            </div>
            <div class="inputfield">
                <label>Email Address</label>
                <input type="text" class="input" name = "dmail" required>
            </div> 
            <div class="inputfield">
                <label>Phone Number</label>
                <input type="text" class="input" name = "dpnum" required>
            </div> 
            <div class="inputfield">
                <label>Address</label>
            ...
            <div class="inputfield">
                <label>Old Fee</label>
                <input type="text" class="input" name = "dolf" required>
            </div>
            <div class="inputfield">
                <label>New Fee</label>
                <input type="text" class="input" name = "dnwf" required>
            </div>
            <div class="inputfield">
                <label>MBBS</label>
                <div class="custom_select">
            ...
            <div class="inputfield">
                ...
                <input type="file" class="input" accept=".pdf" name="file" required>
            </div>
